...
public class HabitacionBusiness {
    ...
    public Habitacion getHabitacionesbyID(Habitacion habitacion) {
    ...
    public int calculaValorCompra(int valorEvento, int cantidadDeDiascomprador) {
        int valor = valorEvento * cantidadDeDiascomprador;
        return valor;
    }
